...
const FrontPage = () => {
  ...
  useEffect(() => {
    const fetchBudgetAndExpenses = async () => {
      try {
        const userRes = await axios.get("https://mern-project-personal-finance-planner.onrender.com/api/finance/budget", {
        ...
        const expenseRes = await axios.get(`https://mern-project-personal-finance-planner.onrender.com/api/finance/all?userId=${userId}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleBudgetSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://mern-project-personal-finance-planner.onrender.com/api/finance/budget",
        { budget: cleanBudget },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleExpenseSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://mern-project-personal-finance-planner.onrender.com/api/finance/add", expenseWithDate, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  if (confirm) {
    try {
      await axios.delete("http://mern-project-personal-finance-planner.onrender.com/api/finance/reset", {
        headers: { Authorization: `Bearer ${token}` },
      });
